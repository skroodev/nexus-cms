...
/**
 * Gérez les articles du blog du site Atelier Nexus
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Post {
  ...
  title: string;
  /**
   * Généré automatiquement à partir du titre (URL-friendly)
   */
  slug: string;
  /**
   * Résumé de l'article (180-200 caractères recommandé)
   */
  excerpt?: string | null;
  /**
  ...
  /**
   * Brouillon = non visible sur le site | Publié = visible pour tous
   */
